			...
			<el-row class="dialog" style="background:#f5f5f5;height:391px;">
				...
				<el-col :span="3">
					<div style="margin-top: 120px;">
						<el-button type="primary" @click="toGrant" icon="arrow-right" size="mini" style="margin-left:15px;">授权<i class="el-icon-arrow-right el-icon--right"></i></el-button>
					</div>
					<div style="margin-top: 60px;">
						<el-button type="primary" @click="cancelGrant" icon="el-icon-arrow-left" size="mini" style="margin-left:15px;">移除</el-button>
					</div>
